          ...
          <div className="text-center pb-4 overflow-hidden">
            <div className="scrolling-text">
              <p className="text-[hsl(var(--b2b-blue))] font-medium whitespace-nowrap">
                ...
                A single platform for your business buying and selling needs • A single platform for your business buying and selling needs • A single platform for your business buying and selling needs • 
              </p>
            </div>
          </div>
        </div>
